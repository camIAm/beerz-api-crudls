...
let selector = {}
  if(filter){
   ...
   (lastItem)?selector['_id']={$gt:lastItem} : selector['_id']={$gt:null}
...
const findDocs = query => db.find(query).then(obj => obj.docs)

module.exports = {addBeer,getBeer,updateBeer,deleteBeer, listBeers}
